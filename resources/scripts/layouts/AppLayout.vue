                ...
                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures" align="right" width="60">
                  <template #trigger>
                    <span class="inline-flex rounded-md">
                      <button type="button" class="duration-15 inline-flex items-center rounded-md border border-transparent bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition ease-in-out hover:text-gray-700 focus:bg-gray-50 focus:outline-none active:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:hover:text-gray-300 dark:focus:bg-gray-700 dark:active:bg-gray-700">
                  ...
                  <template #content>
                    <div class="w-60">
                      ...
                      <template v-if="$page.props.jetstream.hasTeamFeatures">
                        ...
                        <!-- Team Settings -->
                        <DropdownLink :href="`/teams/${$page.props.auth?.user?.current_team?.id}`">
                          Team Settings
                        </DropdownLink>
          ...
          <div class="border-t border-gray-200 pt-4 pb-1 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
              ...
              <template v-if="$page.props.jetstream.hasTeamFeatures">
                ...
                <!-- Team Settings -->
                <ResponsiveNavLink href="`/teams/${$page.props.auth?.user?.current_team}`" :active="$page.url === `/teams/${$page.props.auth?.user?.current_team}`">
                  Team Settings
                </ResponsiveNavLink>
